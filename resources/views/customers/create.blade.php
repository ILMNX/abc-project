                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="shopname">Nomor Whatsapp <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="account_holder">Akun Media Sosial</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="bank_branch">Kewarganegaraan</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="city">Kota Customer <span class="text-danger">*</span></label>
