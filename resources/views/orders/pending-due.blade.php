    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Data Penjualan Kredit</h4>
                </div>
                <div>
                ...
                <table class="table mb-0">
                    <thead class="bg-white text-uppercase">
                        <tr class="ligth ligth-data">
                            <th>No.</th>
                            <th>Invoice No</th>
                            <th>@sortablelink('customer.name', 'Nama Customer')</th>
                            <th>@sortablelink('order_date', 'Tanggal Order')</th>
                            <th>Pembayaran</th>
                            <th>@sortablelink('Bayar')</th>
                            <th>@sortablelink('Kredit')</th>
                            <th>Action</th>
                        </tr>
                    </thead>
