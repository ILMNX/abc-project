                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('invoice_price') is-invalid @enderror" id="invoice_price" name="invoice_price" value="{{ old('invoice_price', $product->invoice_price) }}" required>
                                @error('invoice_price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('le_commisiion') is-invalid @enderror" id="le_commisiion" name="le_commisiion" value="{{ old('le_commisiion', $product->le_commisiion) }}" required>
                                @error('le_commisiion')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('abc_operation_chasir') is-invalid @enderror" id="abc_operation_chasir" name="abc_operation_chasir" value="{{ old('abc_operation_chasir', $product->abc_operation_chasir) }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('leadership_fund') is-invalid @enderror" id="leadership_fund" name="leadership_fund" value="{{ old('leadership_fund', $product->leadership_fund) }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('harga_laporan') is-invalid @enderror" id="harga_laporan" name="harga_laporan" value="{{ old('harga_laporan', $product->harga_laporan) }}" required>
                                @error('harga_laporan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('tithe') is-invalid @enderror" id="tithe" name="tithe" value="{{ old('tithe', $product->tithe) }}" required>
                                @error('tithe')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('harga_le') is-invalid @enderror" id="harga_le" name="harga_le" value="{{ old('harga_le', $product->harga_le) }}" required>
                                @error('harga_le')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('harga_umum') is-invalid @enderror" id="harga_umum" name="harga_umum" value="{{ old('harga_umum', $product->harga_umum) }}" required>
                                @error('harga_umum')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('point_buku') is-invalid @enderror" id="point_buku" name="point_buku" value="{{ old('point_buku', $product->point_buku) }}" required>
                                @error('point_buku')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
