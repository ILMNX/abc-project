                ...
                <div class="card-body">
                    ...
                    <div class=" row align-items-center">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bg-white" value="{{  $product->invoice_price }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Le Commisiion</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->le_commisiion }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>ABC Operation Chasir</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->abc_operation_chasir }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Leadership Fund</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->leadership_fund }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Harga Laporan</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->harga_laporan }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Tithe</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->tithe }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Harga Le</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->harga_le }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Harga Umum</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->harga_umum }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Point Buku</label>
                            <input type="text" class="form-control bg-white" value="{{  $product->point_buku }}" readonly>
                        </div>
                    </div>
                    <!-- end: Show Data -->
                </div>
