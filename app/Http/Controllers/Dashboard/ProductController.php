...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'invoice_price' => 'required|integer',
            'le_commisiion' => 'required|integer',
            'abc_operation_chasir' => 'required|integer',
            'leadership_fund' => 'required|integer',
            'harga_laporan' => 'required|integer',
            'tithe' => 'required|integer',
            'harga_le' => 'required|integer',
            'harga_umum' => 'required|integer',
            'point_buku' => 'required|integer',
        ];
    ...
    function exportData(){
        ...
        foreach($products as $product)
        {
            $product_array[] = array(
                ...
                'Invoice Price' =>$product->invoice_price,
                'Le Commisiion' =>$product->le_commisiion,
                'ABC Operation Chasir' =>$product->abc_operation_chasir,
                'Leadership Fund' =>$product->leadership_fund,
                'Harga Laporan' =>$product->harga_laporan,
                'Tithe' =>$product->tithe,
                'Harga LE' =>$product->harga_le,
                'Harga Umum' =>$product->harga_umum,
                'Point Buku' =>$product->point_buku,
            );
        }
